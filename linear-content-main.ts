...
function firstNonEmptyColor(values) {
...
function readElementColor(selectors, propertyName) {
...
function readLinearTheme() {
  ...
  const baseColor = firstNonEmptyColor([
    readCustomProperty("--color-background-primary"),
    readCustomProperty("--color-bg-primary"),
    readCustomProperty("--color-surface"),
    body ? getComputedStyle(body).backgroundColor : "",
  ]);

  const sidebarColor = firstNonEmptyColor([
    readCustomProperty("--color-sidebar-background"),
    readCustomProperty("--color-sidebar"),
    readCustomProperty("--color-bg-sidebar"),
    readElementColor(["aside", '[data-testid=\"sidebar\"]', "nav"], "backgroundColor"),
  ]);

  const borderColor = firstNonEmptyColor([
    readCustomProperty("--color-border"),
    readCustomProperty("--color-border-subtle"),
    readCustomProperty("--border-color"),
    readElementColor(["aside", '[data-testid=\"sidebar\"]', ".Sidebar"], "borderColor"),
  ]);
